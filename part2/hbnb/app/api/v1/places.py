...
place_model = api.model(
    "Place",
    {
        ...
        # champs “retour enrichi”
        "owner": fields.Nested(user_model, description="Owner of the place"),
        "amenities_details": fields.List(fields.Nested(amenity_model), description="Amenities"),
...
def serialize_place(place):
    ...
    return {
        **place.to_dict(),
        ...
        "amenities_details": [a.to_dict() for a in amenities],
        "reviews": [],  # rempli via endpoint place/<id>/reviews
    }
